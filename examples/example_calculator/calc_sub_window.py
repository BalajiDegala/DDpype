...
class CalculatorSubWindow(NodeEditorWidget):
    ...
    def handleNodeContextMenu(self, event):
        if DEBUG_CONTEXT:
            print("CONTEXT: NODE")
        context_menu = QMenu(self)
        markDirtyAct = context_menu.addAction("GET SHOW")
        markDirtyDescendantsAct = context_menu.addAction("HET SEQ")
        markInvalidAct = context_menu.addAction("GET ASSET")
        unmarkInvalidAct = context_menu.addAction("GET ARTIST")
        evalAct = context_menu.addAction("GET DEPT")
